    ...
    return(
        <div className="glass-card rounded-3xl backdrop-blur-xl border border-white/30 w-full h-full flex flex-col">
            <div className="flex flex-col items-center p-6">
                <div className="mb-4">
                    <img src={profileImg} className="rounded-full w-32 h-32 object-cover border-2 border-aeroBlue" alt="animate gif of johiny"/>
                </div>
                <div className="flex flex-col flex-grow w-full">
                    <h2 id="myDescription" className="text-base md:text-lg bg-black bg-opacity-50 p-3 rounded-lg backdrop-blur-sm flex-grow">
                        <Typewriter
                            delaySpeed={1700}
